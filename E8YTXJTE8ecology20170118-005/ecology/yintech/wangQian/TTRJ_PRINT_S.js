jQuery(document).ready(function(){
	...
	var htmlstr ='<a href="/yintech/print/TT_RJHY_S.jsp?requestid='+ rqstid +'" target="_blank"><span style="font-size:12pt;letter-spacing:2px;text-align:center;color:red;margin:4px 40px;line-height:26px;">合同打印</span></a>';
