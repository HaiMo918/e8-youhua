...
var pageObj = {   //页面对象   系统当前月?荩涂突Ъ锹夹畔?
		thisMonth:"thisMonth",
		customer:{   									//客户信息模板
			name					: '',   							//客户姓名
			cardNumbe			: '', 		//身份证编号
...
jQuery(document).ready(function(){
    ...
    */
	...
	jQuery("#"+jysxfsq1).change(function(){//交易所手续费奖励比例    (25,100]，最小变更单位25
	...
	jQuery("#"+jyyqfysq).change(function(){//交易延期费优惠比例  (25,100]，最小变更单位25
	...
	jQuery("#"+crjjz).change(function(){	//累计出入金净值不低于 正整数，默认为??
