...
<% 
	...
	String yhxyyxqz 	 =  rst.getString("yhxyyxqxzi");  	 //优惠协议开始日期
	String yhxyyxqjz     =  rst.getString("yhxyyxqxz"); 	 //优惠协议结束日期
	String dkyhkhh 	     =  rst.getString("dkyhkhh"); 		 //打款银行开户行
	String dkyhzhkh 	 =  rst.getString("dkyhzh");  	 //打款银行账号
	String ssx 			 =  rst.getString("ssx");  			 // 省市县
	String fzh 			 =  rst.getString("fzh");  				 // 分/支行

	String sxfjl	     =  rst.getString("jyssxfjlbl");  		//  交易所手续费优惠比例
	String sxfyh		 =  rst.getString("hysxfyhbl");  	     // 会员手续费优惠比例
	String yqfyh	     =  rst.getString("jyyqfyhbl");  		// 交易延期费优惠比例
    String ljcrjjzbdy	 =  rst.getString("ljcrjjzbdy");        // 累计出入金净值不低于

	String jyssxfjlwb 	 =  rst.getString("jyssxfjlblwb");       // 交易所手续费优惠比例  文本
	String hysxfyhwb     =  rst.getString("hysxfyhwb");          // 会员手续费优惠比例
	String jyyqfyhwb     =  rst.getString("jyyqfyhblwb");              // 交易延期费优惠比例   文本
	String crjdx 	     =  rst.getString("crjwb");  			 // 累计出入金净值  文本

	String htbh 	     =  rst.getString("htbh");  			// 合同编号
	
	String[] yhxyyxqzArr = yhxyyxqz.split("-");//优惠开始日期
	String year_b 		=   yhxyyxqzArr[0]; //   年
	String month_b    =   yhxyyxqzArr[1]; //   月
	String day_b 		=   yhxyyxqzArr[2]; //    日
	
	String[] yhxyyxqjzArr = yhxyyxqjz.split("-");//优惠结束日期
...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="height:60px; margin-top:20px;  line-height:50px;  font-size:38px; text-align:center; font-weight:bold;  font-family:STXinwei;  position: relative;  /* border:1px solid red;   */ " >
		交易费用优惠协议<div style="position:absolute; right:-23px; top:0px;   height:25px;  line-height:20px; width:300px;  font-size: 14px; font-weight: bold; vertical-align: top; " >编号：<%=htbh %></div>
	</div>
	...
	<div style="margin: 0px; line-height: 25px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;本协议专为金祥银瑞公司优质客户提供，客户除享有公司的基本服务之外，还获得交易费用的优惠，上述优惠额度的核算包含客户在金祥银瑞公司交易的所有品种。
	</div>
	<div style="margin: 0px; height: 34px; line-height:34px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	协议内容：
	</div>
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过广东贵金属交易所（以下简称“交易所”）交易平台进行交易，金祥银瑞收取的手续费减免比例为 	
		<%-- <span style="display:inline-block; height: 17px;  text-align:center;  width: 100px; border-bottom: 1px solid #000;"  >百分之<%=hysxfyhwb %></span> --%><label style="padding-bottom:3px; border-bottom:1px solid #000;"  >&nbsp;&nbsp;百分之<%=hysxfyhwb %>&nbsp;&nbsp;</label>；
		收取的滞纳金减免比例为 <%-- <span style="display:inline-block; height: 17px;  text-align:center;  width: 100px; border-bottom: 1px solid #000;"  >百分之<%=jyyqfyhwb %></span> --%><label style="padding-bottom:3px; border-bottom:1px solid #000;" >&nbsp;&nbsp;百分之<%=jyyqfyhwb %>&nbsp;&nbsp;</label>；
		如交易所交易系统实际收取的手续费和滞纳金高于双方约定标准，其产生的交易费用差额部分将由金祥银瑞进行优惠减免，并通过转账的方式退还到客户本人与交易所绑定的银行资金账户，最终到账金额为以上优惠部分的扣除税金后金额。（注：若后期交易所后台系统能够自由调整交易手续费和滞纳金收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
	

	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 优惠协议有效期限：自<span style="display:inline-block; text-align:center;   height: 20px; width: 40px; border-bottom: 1px solid #000;"  ><%=year_b %></span>  年  <span style="display:inline-block;  height: 20px; text-align:center;   width: 40px; border-bottom: 1px solid #000;"  ><%=month_b %></span> 月 <span style="display:inline-block; text-align:center;   height: 20px; width: 40px; border-bottom: 1px solid #000;"  ><%=day_b %></span> 日 
		&nbsp;&nbsp;至&nbsp;&nbsp;
	...
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 优惠金额结算周期：以月为周期结算，每个月的最后一交易日为一个结算周期的截止日（以下简称“结算日”）；
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 返还优惠金额时间：每个结算日的次月15日（遇节假日顺延）；
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 返还优惠金额方式：银行划转入客户本人交易所绑定的银行资金账户：
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;账户姓名：<span style="display:inline-block;  height: 20px; width: 80px; border-bottom: 1px solid #000;"  ></span>  开户行：<span style="display:inline-block;  height: 20px; width: 150px; border-bottom: 1px solid #000;"  ><%=dkyhkhh%></span> 银行<span style="display:inline-block;  height: 20px; width: 80px; border-bottom: 1px solid #000;"  ><%=ssx %></span>省/市 <span style="display:inline-block;  height: 20px; border-bottom: 1px solid #000;"  ><%=fzh %></span>分行；
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
			&nbsp;&nbsp;&nbsp;&nbsp;1、	遵守国家法律、法规和政策、遵守广东贵金属交易所的相关规章制度。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;4、	愿意协助金祥银瑞公司做好正面宣传工作。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;注：累计出入金净值指客户自开户至本次结算日的总入金减去总出金；日均出入金净值=期初累计出入金净值+（结算月每日累计净值*资金在当月的累计交易日天数）/当月总交易日天数。（如果协议起始月或截止月非整月，则按照当月优惠的有效天数计算日均净值）
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;1、	客户同意，若本协议有效期内，客户未能满足本协议项下的优惠条件，金祥银瑞公司有权即刻暂停当月向客户提供优惠服务。
	</div>
	...
	<div style="position:absolute; bottom:0px; right:0px;  width: 100%; font-size: 14px; color: #ccc; font-weight: bold; text-align: right;  " >&nbsp;&nbsp;银科控股（Nasdaq代码：YIN）旗下品牌&nbsp;&nbsp;</div>
</div>
...
<div style="position:relative;   border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	客户同意，若本协议有效期内，客户账户存在异常情况或某个品种的操作存在异常情况的，金祥银瑞公司有权选择提前终止本协议或针对操作异常的品种终止提供交易优惠服务。基于交易所对客户交易行为合规化的要求，及金祥银瑞公司倡导客户本人操作，确保账户安全等原因，客户理解并同意，如发生下列任一情形，不论客户入金多少，金祥银瑞有权即刻终止优惠，并保留追索客户已获得之优惠的权利：
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;f)	违反交易所相关规则制度，或者本协议附件规定的其他情形；
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;3、	客户同意，遇国家相关法律、法规及广东贵金属交易所相关交易规则变更的，金祥银瑞公司有权选择提前终止本协议或修改本协议优惠条件及要求（包括但不限于费用收取标准、优惠条件及要求等）。金祥银瑞公司选择修改本协议的，若客户接受，双方另行签署书面协议予以确认；若客户不接受，金祥银瑞公司有权提前终止本协议。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;4、	金祥银瑞公司按照本条1、2、3款规定提前终止或修改协议的，客户无权要求金祥银瑞公司承担任何违约或其他责任。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-weight: bold;"  >客户申请及承诺：</label>本人愿意遵守金祥银瑞有关交易费用优惠协议的规定，接受相关服务内容，并愿意自行承担交易中的风险；若出现以上要求未能满足或本人账户异常的情况，本人同意放弃金祥银瑞交易费用优惠协议的特权服务，并同意金祥银瑞公司提前终止本协议，本人不得因此要求金祥银瑞公司承担任何违约或其他责任。现郑重向金祥银瑞申请交易费用优惠服务，自本协议签订之日起，客户之前与金祥银瑞公司签署的《交易费用优惠协议》将自动作废，以本协议为准！同时本人已领取本优惠协议原件/复印件壹份。
本人已认真阅读并完全理解和同意上述交易费用优惠协议的全部条款，并承诺本人应严格遵守“客户申请及承诺”部分内容。
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  > 
		&nbsp;&nbsp;&nbsp;&nbsp;a)	客户在办理开户业务时（包括电子化开户以及非电子化开户等交易所认可的任何一种开户方式）非本人亲自办理的；
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  > 
		&nbsp;&nbsp;&nbsp;&nbsp;b)	客户的开户资料非本人亲自签署，委托其他人代为签署的；
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  > 
		&nbsp;&nbsp;&nbsp;&nbsp;c)	客户拒绝、不配合会员单位或交易所电话回访，或者在回访时无法提供准确信息的；
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  > 
...
<div style=" position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px;  line-height: 20px;  padding: 5px;  padding-right: 0px;"  > 
			&nbsp;&nbsp;&nbsp;&nbsp;b)	客户单笔成交数量达到交易所单笔交易限额或单笔交易限额达到交易所规定单笔交易限额80%以上的；
	</div>		
	<div style="margin: 0px;  line-height: 20px;  padding: 5px;   padding-right: 0px;"  > 
	...
	<div style="margin: 0px;  line-height: 20px;  padding: 5px; "  > 
			&nbsp;&nbsp;&nbsp;&nbsp;h)	关联账户组的登录或退出IP地址一?禄騃P地址虽不尽相同但属于同一物理地址的；
	</div>		
	<div style="margin: 0px;  line-height: 20px;  padding: 5px; "  > 
			&nbsp;&nbsp;&nbsp;&nbsp;i)	单一账户客户单日成交笔数达到30笔以上的；
	</div>		
	<div style="margin: 0px;  line-height: 20px;  padding: 5px; "  > 
			&nbsp;&nbsp;&nbsp;&nbsp;j)	交易所、会员单位认定客户交易异常的其他情形。
	</div>		
	...
	<div style="margin: 0px;  line-height: 20px;  padding: 5px; "  > 
		&nbsp;&nbsp;&nbsp;&nbsp;a)	客户持仓达到交易所规定的持仓限额或交易所规定的持仓限额80%以上的；
	</div>		 			
	<div style="margin: 0px;  line-height: 20px;  padding: 5px; "  > 
