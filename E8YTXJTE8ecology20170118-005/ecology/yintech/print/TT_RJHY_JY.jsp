...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px; line-height: 25px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;本协议专为融金汇银公司优质客户提供，客户除享有公司的基本服务之外，还获得交易费用的奖励，上述奖励额度的核算包含客户在融金汇银公司交易的所有品种。
	</div>
	<div style="margin: 0px; height: 34px; line-height:34px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	协议内容：
	</div>
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过天津贵金属交易所（以下简称“交易所”）交易平台进行交易，交易所收取的手续费奖励比例为<label style="padding-bottom:3px; border-bottom:1px solid #000;" >百分之<%=jyssxfjlwb%>&nbsp;&nbsp;</label>；交易延期费奖励比例为<label style="padding-bottom:3px; border-bottom:1px solid #000;" >&nbsp;&nbsp;百分之<%=jyyqfyhwb %>&nbsp;&nbsp;</label>；如交易所交易系统实际收取的手续费高于双方约定标准，其产生的交易费用差额部分将由融金汇银作为奖励，并通过转账的方式退还到客户本人与交易所绑定的银行资金账户，最终到账金额为以上奖励部分的扣除税金后金额。（注：若后期交易所后台系统能够自由调整交易手续费收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
	...
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 返还奖励金额方式：银行划转入客户本人交易所绑定的银行资金账户：
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;1、	客户同意，若本协议有效期内，客户未能满足本协议项下的奖励条件，融金汇银公司有权即刻暂停当月向客户提供奖励服务。
	</div>
...
<div style="position:relative;   border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	客户同意，若本协议有效期内，客户账户存在异常情况或某个品种的操作存在异常情况的，融金汇银公司有权选择提前终止本协议或针对操作异常的品种终止提供交易奖励服务。基于交易所对客户交易行为合规化的要求，及融金汇银公司倡导客户本人操作，确保账户安全等原因，客户理解并同意，如发生下列任一情形，不论客户入金多少，融金汇银有权即刻终止奖励，并保留追索客户已获得之奖励的权利：
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;3、	客户同意，遇国家相关法律、法规及天津贵金属交易所相关交易规则变更的，融金汇银公司有权选择提前终止本协议或修改本协议奖励条件及要求（包括但不限于费用收取标准、奖励条件及要求等）。融金汇银公司选择修改本协议的，若客户接受，双方另行签署书面协议予以确认；若客户不接受，融金汇银公司有权提前终止本协议。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;4、	融金汇银公司按照本条1、2、3款规定提前终止或修改协议的，客户无权要求融金汇银公司承担任何违约或其他责任。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-weight: bold;"  >客户申请及承诺：</label>本人愿意遵守融金汇银有关交易费用奖励协议的规定，接受相关服务内容，并愿意自行承担交易中的风险；若出现以上要求未能满足或本人账户异常的情况，本人同意放弃融金汇银交易费用奖励协议的特权服务，并同意融金汇银公司提前终止本协议，本人不得因此要求融金汇银公司承担任何违约或其他责任。现郑重向融金汇银申请交易费用奖励服务，自本协议签订之日起，客户之前与融金汇银公司签署的《交易费用奖励协议》将自动作废，以本协议为准！同时本人已领取本奖励协议原件/复印件壹份。
本人已认真阅读并完全理解和同意上述交易费用奖励协议的全部条款，并承诺本人应严格遵守“客户申请及承诺”部分内容。
	...
	<div style="position:absolute; bottom:0px; right:0px;  width: 100%; font-size: 14px; color: #ccc; font-weight: bold; text-align: right;  " >&nbsp;&nbsp;银科控股（Nasdaq代码：YIN?┢煜鹿?nbsp;&nbsp;</div>
</div>
