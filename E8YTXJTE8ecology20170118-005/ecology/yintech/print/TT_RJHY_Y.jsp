...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过天津贵金属交易所（以下简称“交易所”）交易平台进行交易，交易延期费奖励比例为<label style="padding-bottom:3px; border-bottom:1px solid #000;" >百分之<%=jyyqfyhwb %>&nbsp;&nbsp;</label>；并通过转账的方式退还到客户本人与交易所绑定的银行资金账户，最终到账金额为以上奖励部分的扣除税金后金额。（注：若后期交易所后台系统能够自由调整交易手续费收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
