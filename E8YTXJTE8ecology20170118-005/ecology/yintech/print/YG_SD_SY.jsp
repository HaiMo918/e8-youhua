...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px; line-height: 25px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;本协议专为盛鼎公司优质客户提供，客户除享有公司的基本服务之外，还获得交易费用的优惠，上述优惠额度的核算包含客户在盛鼎公司交易的所有品种。
	</div>
	<div style="margin: 0px; height: 34px; line-height:34px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	协议内容：
	</div>
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过广东贵金属交易所（以下简称“交易所”）交易平台进行交易，盛鼎收取的手续费减免比例为
	  <label style="padding-bottom:3px; border-bottom:1px solid #000;"  >百分之<%=hysxfyhwb %>&nbsp;&nbsp;</label>；
		收取的延期费减免比例为<label style="padding-bottom:3px; border-bottom:1px solid #000;" >百分之<%=jyyqfyhwb %>&nbsp;&nbsp;</label>；
		如交易所交易系统实际收取的手续费和滞纳金高于双方约定标准，其产生的交易费用差额部分将由盛鼎进行优惠减免，并通过转账的方式退还到客户本人与交易所绑定的银行资金账户，最终到账金额为以上优惠部分的扣除税金后金额。（注：若后期交易所后台系统能够自由调整交易手续费和滞纳金收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;1、	客户同意，若本协议有效期内，客户未能满足本协议项下的优惠条件，盛鼎公司有权即刻暂停当月向客户提供优惠服务。
	</div>
...
<div style="position:relative;   border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	客户同意，若本协议有效期内，客户账户存在异常情况或某个品种的操作存在异常情况的，盛鼎公司有权选择提前终止本协议或针对操作异常的品种终止提供交易优惠服务。基于交易所对客户交易行为合规化的要求，及盛鼎公司倡导客户本人操作，确保账户安全等原因，客户理解并同意，如发生下列任一情形，不论客户入金多少，盛鼎有权即刻终止优惠，并保留追索客户已获得之优惠的权利：
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;3、	客户同意，遇国家相关法律、法规及广东贵金属交易所相关交易规则变更的，盛鼎公司有权选择提前终止本协议或修改本协议优惠条件及要求（包括但不限于费用收取标准、优惠条件及要求等）。盛鼎公司选择修改本协议的，若客户接受，双方另行签署书面协议予以确认；若客户不接受，盛鼎公司有权提前终止本协议。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;4、	盛鼎公司按照本条1、2、3款规定提前终止或修改协议的，客户无权要求盛鼎公司承担任何违约或其他责任。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-weight: bold;"  >客户申请及承诺：</label>本人愿意遵守盛鼎有关交易费用优惠协议的规定，接受相关服务内容，并愿意自行承担交易中的风险；若出现以上要求未能满足或本人账户异常的情况，本人同意放弃盛鼎交易费用优惠协议的特权服务，并同意盛鼎公司提前终止本协议，本人不得因此要求盛鼎公司承担任何违约或其他责任。现郑重向盛鼎申请交易费用优惠服务，自本协议签订之日起，客户之前与盛鼎公司签署的《交易费用优惠协议》将自动作废，以本协议为准！同时本人已领取本优惠协议原件/复印件壹份。
