...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:300mm;" >
	<div style="border-bottom:2px solid #000;" ><img src="/yintech/print/yry.jpg" /></div>
	<DIV align=center>
	...
	<div style="margin: 0px; line-height: 30px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;本协议专为金祥银瑞公司优质客户提供，客户除享有公司的基本服务之外，还获得交易费用优惠服务，上述优惠服务针对客户在金祥银瑞公司交易的所有品种。
	</div>
	<div style="margin: 0px; height: 34px; line-height:34px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	协议内容：
	</div>
	...
	* 经双方友好协商，自本协议约定之日起，该客户个人账户通过交易中心交易平台进行交易，交易手续费就金祥银瑞公司收取的手续费按照<label style="padding-bottom:3px; border-bottom:1px solid #000;"  >&nbsp;&nbsp;百分之<%=hysxfyhwb %>&nbsp;&nbsp;</label>的比例减免 (该交易手续费款项国家规定需缴纳相应的税费，税率为6%，即客户收取的手续费优惠减免金额需扣除6%的税费之后为客户实际收到的返还金额)。该优惠减免比例税后的相应手续费减免金额将由金祥银瑞公司通过转账的方式退还到客户本人与交易中心绑定的银行资金账户。（注：若后期交易中心后台系统能够自由调整交易手续费收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 返还优惠金额方式：银行划转入客户本人交易中心绑定的银行资金账户：
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;账户姓名：<span style="display:inline-block;  height: 20px; width: 80px; border-bottom: 1px solid #000;"  ></span>  开户行：<span style="display:inline-block;  height: 20px; width: 150px; border-bottom: 1px solid #000;"  ><%=dkyhkhh%></span> 银行<span style="display:inline-block;  height: 20px; border-bottom: 1px solid #000;"  ><%=ssx %></span>省/市 <span style="display:inline-block;  height: 20px; border-bottom: 1px solid #000;"  ><%=fzh %></span>分行；
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
			&nbsp;&nbsp;&nbsp;&nbsp;1、	遵守国家法律、法规和政策、遵守广东贵金属交易中心的相关规章制度。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 5px; "  >
...
<div style="position:relative;   border:1px solid #fff; width:210mm; height:300mm;" >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;2、	客户同意，若本协议有效期内，客户账户存在异常情况或某个品种的操作存在异常情况的，金祥银瑞公司有权选择提前终止本协议或针对操作异常的品种终止提供交易优惠服务。基于交易中心对客户交易行为合规化的要求，及金祥银瑞公司倡导客户本人操作，确保账户安全等原因，客户理解并同意，如发生下列任一情形，不论客户入金多少，金祥银瑞有权即刻终止优惠，并保留追索客户已获得之优惠的权利：
	</div>
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;3、	客户同意，遇国家相关法律、法规及广东贵金属交易中心相关交易规则变更的，金祥银瑞公司有权选择提前终止本协议或修改本协议优惠条件及要求（包括但不限于费用收取标准、优惠条件及要求等）。金祥银瑞公司选择修改本协议的，若客户接受，双方另行签署书面协议予以确认；若客户不接受，金祥银瑞公司有权提前终止本协议。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
