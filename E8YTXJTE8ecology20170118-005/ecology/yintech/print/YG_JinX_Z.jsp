...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="height:60px; margin-top:20px;  line-height:50px;  font-size:38px; text-align:center; font-weight:bold;  font-family:STXinwei;  position: relative;  /* border:1px solid red;   */ " >
		交易费用优惠协议<div style="position:absolute; right:0px; top:-23px;   height:25px;  line-height:20px; width:300px;  font-size: 14px; font-weight: bold; vertical-align: top; " >编号：<%=htbh %></div>
	</div>
	...
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过广东贵金属交易所（以下简称“交易所”）交易平台进行交易，金祥银瑞收取的滞纳金减免比例为 
		<label style="padding-bottom:3px; border-bottom:1px solid #000;"  >&nbsp;&nbsp;百分之<%=hysxfyhwb %>&nbsp;&nbsp;</label>；
		如交易所交易系统实际收取的滞纳金高于双方约定标准，其产生的交易费用差额部分将由金祥银瑞进行优惠减免，并通过转账的方式退还到客户本人与交易所绑定的银行资金账户，最终到账金额为以上优惠部分的扣除税金后金额。（注：若后期交易所后台系统能够自由调整交易滞纳金收取标准，交易系统将直接按照本协议约定的费率标准调整收取）。
	</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
