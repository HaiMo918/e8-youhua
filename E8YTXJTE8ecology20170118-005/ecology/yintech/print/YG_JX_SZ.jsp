...
<% 
	...
	String sqlStr ="select khxm,khid,jyzh,sfzh,yhxyyxqxzi,yhxyyxqxz,dkyhkhh,dkyhzhkh,ssx,fzh,hysxfyhbl,jyssxfjlbl,jyyqfjlbl,ljcrjjzbdy,hysxfyhblwb,jyssxfjlblwb,jyfyqfyhblwb,crjwb,htbh from formtable_main_130 where requestid =  " + rqstid ;
	...
	String yhxyyxqz 	 =  rst.getString("yhxyyxqxzi");  	 //奖励协议开始日期
	String yhxyyxqjz     =  rst.getString("yhxyyxqxz"); 	 //奖励协议结束日期
	...
	String hysxfyhwb     =  rst.getString("hysxfyhwb");     // 会员手续费奖励比例
	String jyssxfjlwb 	 =  rst.getString("jyssxfjlblwb");    // 交易所手续费奖励比例  文本
	String jyyqfyhwb     =  rst.getString("jyfyqfyhblwb");     // 交易延期费奖励比例   文本
...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="height:60px; margin-top:20px;  line-height:50px;  font-size:38px; text-align:center; font-weight:bold;  font-family:STXinwei;  position: relative;  /* border:1px solid red;   */ " >
		交易费用优惠协议<div style="position:absolute; right:0px; top:0px;   height:25px;  line-height:20px; width:300px;  font-size: 14px; font-weight: bold; vertical-align: top; " >编号：<%=htbh %></div>
	</div>
