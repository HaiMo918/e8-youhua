...
function compareDate3(){
	...
	date1 = ss1[0]+"/"+ss1[1]+"/"+ss1[2] + " " +time1;
	date2 = ss2[0]+"/"+ss2[1]+"/"+ss2[2] + " " +time2;
...
function doSave(obj){
	...
	if(check_form(document.weaver,needcheck)&&compareDate3()&&checkDateValidity(begindate,$('#begintime').val(),enddate,$('#endtime').val(),"<%=SystemEnv.getHtmlLabelName(16722,user.getLanguage())%>")){
		if(checkAddress()){
