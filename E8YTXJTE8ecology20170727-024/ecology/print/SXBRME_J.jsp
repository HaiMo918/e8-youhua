...
<div style="position:relative;  border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px; line-height: 25px;  "  >
		&nbsp;&nbsp;&nbsp;&nbsp;* 经双方友好协商，自本协议约定之日起，客户个人账户通过陕西一带一路大宗商品交易中心(以下简称“交易中心”)交易平台进行交易，交易中心收取的手续费奖励比例为<label style="padding-bottom:3px; border-bottom:1px solid #000;" >百分之<%=jyssxfjlwb%>&nbsp;&nbsp;</label>；并通过转账的方式退还到客户本人与交易中心绑定的银行资金账户，最终到账金额为以上奖励部分的扣除税金后金额。(注：若后期交易中心后台系统能够自由调整交易手续费收取标准，交易系统将直接按照本协议约定的费率标准调整收取)。</div>
	<div style="margin: 0px;  line-height: 25px;  "  >
...
<div style="position:relative;   border:1px solid #fff; width:210mm; height:297mm;" >
	...
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
		&nbsp;&nbsp;&nbsp;&nbsp;3、	客户同意，遇国家相关法律、法规及陕西一带一路大宗商品交易中心相关交易规则变更的，盛鼎公司有权选择提前终止本协议或修改本协议奖励条件及要求（包括但不限于费用收取标准、奖励条件及要求等）。盛鼎公司选择修改本协议的，若客户接受，双方另行签署书面协议予以确认；若客户不接受，盛鼎公司有权提前终止本协议。
	</div>
	<div style="margin: 0px;  line-height: 25px;  padding: 4px; "  >
